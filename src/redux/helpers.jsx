...
export const POST_USK =
  "https://api.jamskills.ml/api/testingusers/setquizzes/1/usk/answers";

export const POST_GATB =
  "https://api.jamskills.ml/api/testingusers/setquizzes/1/gatb_5/answers";
